      ...
      <Fragment>
        ...
        <div class="main-wrapper" style={{ marginTop: 50 }}>
          <div class="account-page">
            <div class="container">
              <h3 class="account-title">Forget Your Password</h3>
              <div class="account-box">
                <div class="account-wrapper">
                  ...
                  <form
                    onSubmit={this.props.handleSubmit(this.onSubmitForget)}
                    action="#"
                  >
...
const component = connect(null, { userPostFetch })(Forget);

export default reduxForm({ form: "Forget Form" })(component);
