...
class EditFAQ extends Component {
  ...
  onSubmitRegister = async values => {
    ...
    axios
      .put(`/activities/faq/edit`, values, {
        headers: {
            'x-auth-token': token
        }
      })
    ...
    return (
        <Fragment>
            ...
            <div className="account-page" style={{ marginTop: 30 }}>
                ...
                <h3 className="account-title">Update FAQ</h3>
...
const mapStateToProps=(state)=>{
  return {
    initialValues: state.faqData.faq
  }

}

export default connect(mapStateToProps, { getFQA })(reduxForm({
